			...
			<ul className={nav_styles.navbar_nav}>
				<li className={nav_styles.logo}>
					<Link href="/"><a className={nav_styles.nav_link}>
						<span className={nav_styles.link_text, nav_styles.logo_text}>AAPP5</span>
				...
				<li className={nav_styles.nav_item}>
					<Link href="https://github.com/gOps132/aapp5_2nd_qtr_pt"><a className={nav_styles.nav_link}>
						<GithubBrandIcon/>
